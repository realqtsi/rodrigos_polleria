                    ...
                    >
                        ...
                        <div className="p-6 border-b border-gray-100 flex items-center justify-between bg-slate-50 print:hidden">
                            <div className="flex items-center gap-3">
                                <div className="p-2 bg-rodrigo-terracotta rounded-lg text-white">
                                    <FileText size={24} />
                                </div>
                        ...
                        <div className="flex-1 overflow-y-auto p-8 print:p-0 print:overflow-visible">
                            <div className="report-container max-w-4xl mx-auto bg-white print:w-full">
                                ...
                                {/* Header del Reporte */}
                                <div className="flex justify-between items-start border-b-4 border-rodrigo-terracotta pb-6 mb-8">
                                    <div>
                                        <h1 className="text-3xl font-black text-slate-900 mb-1">Rodrigo's - Brasas & Broasters CHICKEN</h1>
                                        <p className="text-slate-500 font-medium">VENTA DE POLLOS A LA BRASA Y PARRILLADAS</p>
                                ...
                                <div className="grid grid-cols-3 gap-6 mb-8">
                                    ...
                                    <div className="bg-rodrigo-terracotta/5 p-4 rounded-2xl border border-rodrigo-terracotta/10">
                                        <div className="flex items-center gap-2 mb-2 text-rodrigo-terracotta">
                                ...
                                <div className="grid grid-cols-2 gap-8 mb-10">
                                    <div>
                                        <h3 className="text-sm font-bold text-slate-800 mb-4 border-l-4 border-rodrigo-terracotta pl-3">Desglose de Ingresos</h3>
                                                ...
                                                <div className="p-3 bg-slate-50 rounded-xl">
                                                    ...
                                                    <div className="space-y-2">
                                                        <div className="flex justify-between text-sm">
                                                            ...
                                                            <span className="font-bold text-rodrigo-terracotta">{invFinal?.stock_pollos_real ?? '---'}</span>
                                                        </div>
                                                        <div className="flex justify-between text-sm">
                                                            <span className="text-slate-600 font-medium">Papas (Kg)</span>
                                                            <span className="font-bold">{invInicial.papas_iniciales ?? 0}</span>
                                                            <span className="font-bold text-rodrigo-terracotta">{invFinal?.papas_finales ?? '---'}</span>
                                                        </div>
                                                        <div className="flex justify-between text-sm">
                                                            <span className="text-slate-600 font-medium">Gaseosas (Unid)</span>
                                                            <span className="font-bold">{invInicial.gaseosas}</span>
                                                            <span className="font-bold text-rodrigo-terracotta">{invFinal?.stock_gaseosas_real ?? '---'}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            .map(([nombre, data], i) => (
                                                <div key={i} className="flex justify-between items-center py-1 border-b border-slate-50 text-sm">
                                                    ...
                                                    <div className="flex items-center gap-4 shrink-0">
                                                        <span className="font-black text-rodrigo-terracotta w-8 text-right underline underline-offset-4 decoration-1 decoration-rodrigo-terracotta/30">x{data.cant}</span>
                                ...
                                <div className="mt-20 flex justify-between items-end border-t border-slate-100 pt-8 print:mt-12">
                                    <div className="text-center w-64 border-t border-slate-300 pt-2">
                                        ...
                                        <p className="text-[10px] text-slate-400">Rodrigo's - Brasas & Broasters CHICKEN</p>
                                    </div>
                                    <div className="text-right">
                        ...
                        <div className="p-4 bg-slate-50 border-t border-gray-100 text-center print:hidden">
                            <p className="text-[10px] text-slate-400 uppercase tracking-widest font-bold">
                                Sistema de Gestión Administrativa Rodrigo's - Brasas & Broasters v1.0
                            </p>
                        </div>
                    </motion.div>
                </div>
